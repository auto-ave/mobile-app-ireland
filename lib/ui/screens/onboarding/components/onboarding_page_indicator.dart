...
class OnboardingPageIndicator extends StatelessWidget {
  ...
  Color _getPageIndicatorColor(int pageIndex) {
    return currentPage >= pageIndex
        ...
        : SizeConfig.kPrimaryColor.withOpacity(0.25);
  }

  double get indicatorGap => pi / 12;
  double get indicatorLength => (2 * pi / 4) - indicatorGap;

  @override
  Widget build(BuildContext context) {
    return CustomPaint(
      painter: _OnboardignPageIndicatorPainter(
        color: _getPageIndicatorColor(0), startAngle: angle,
        // startAngle:
      ...
      child: CustomPaint(
          painter: _OnboardignPageIndicatorPainter(
            ...
            startAngle: angle + (1 * indicatorLength) + indicatorGap,
          ...
          child: CustomPaint(
            painter: _OnboardignPageIndicatorPainter(
              ...
              startAngle: angle + (2 * indicatorLength) + (2 * indicatorGap),
            ...
            child: CustomPaint(
              painter: _OnboardignPageIndicatorPainter(
                startAngle: angle + (3 * indicatorLength) + (3 * indicatorGap),
